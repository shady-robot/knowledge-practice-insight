...
string promptUserForFile(ifstream & infile, string prompt ="");
  ...
  * the function.
  * 
  * If the requested file does not exist, the user is given additional chances
  * to enter a valid file name, The optional prompt argument is used to give
  * the user more information about the desired input file.
  */
